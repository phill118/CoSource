...
This repository currently contains the frontend engineering foundation only. Commerce providers, product discovery, recommendation logic, purchasing workflows, and WebMCP integrations are not implemented.
