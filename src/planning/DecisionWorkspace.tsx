...
export function DecisionWorkspace({ products, evidenceProducts, plan, planEvaluation, comparison, comparisonIds, pendingProposal, onClearComparison, onAddProduct, onRemoveLine, onSetQuantity, onSelectOffer, onRebase }: {
  ...
  pendingProposal:boolean;onAddProduct:(identity:ProviderIdentity)=>void;onRemoveLine:(lineId:string)=>void;onSetQuantity:(lineId:string,quantity:number)=>void;onSelectOffer:(lineId:string,offer?:ProviderIdentity)=>void;onRebase:()=>void
}) {
