...
The kernel owns the active project's supplier records and every human supplier mutation. React and WebMCP consume this state; persistence serializes it; none is an independent authority.
